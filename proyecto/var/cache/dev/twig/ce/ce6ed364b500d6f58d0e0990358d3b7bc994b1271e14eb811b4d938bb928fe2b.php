...
class __TwigTemplate_23b2f008400cdf7f3b7c4e1217a9f443089768ebc83c9352945a42903603ec04 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <div id=\"container\" class=\"container d-flex align-items-center justify-content-center bg-white shadow p-1 mb-5 bg-body rounded\">
    <form method=\"post\">
        ";
        // line 8
        ...
        >
        <br>
        <button class=\"btn btn-md btn-primary mr-10\" type=\"submit\">
            Sign in
        </button>
    </div>
</form>
...
{% block body %}
    <div id=\"container\" class=\"container d-flex align-items-center justify-content-center bg-white shadow p-1 mb-5 bg-body rounded\">
    <form method=\"post\">
        {% if error %}
